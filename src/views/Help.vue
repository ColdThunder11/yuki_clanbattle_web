  ...
  <div>
    <el-main>
      ...
      <el-table
        ...
        border
        class="bot-help"
        style="width: 100%; background-color: rgba(255, 255, 255, 0)"
    ...
    return {
      tableData: [
        ...
        },
        {
          ...
          description: "报刀，伤害单位可以使用w,kw,e，如加上整则上报为完整刀，否则默认优先上报为补偿刀，无补偿刀时上报为完整到刀",
        },
        {
          command: "尾刀(整)[1-5](:注释)(@某人)",
          description: "收尾刀报刀，如加上整则上报为完整刀，否则默认优先上报为补偿刀，无补偿刀时上报为完整到刀",
        },
        {
          command: "状态",
          description: "查看当前公会战状态",
        },
        {
          command: "查[1-5]",
          description: "查看指定boss状态",
        },
        {
          command: "申请(出刀)[1-5](:注释)",
          description: "申请出刀",
        },
        {
          command: "取消申请",
          description: "撤销当前出刀申请",
        },
        {
          command: "出刀表",
        ...
        },
        {
          ...
          description: "预约boss，将在boss可以被挑战时通知",
        },
        {
          command: "取消预约[1-5] (周目)",
